...
Es gilt weiterhin: $$y<\frac{r}{\alpha}\rightarrow \frac{dx}{dt}=rx-\alpha xy>rx-\alpha x\frac{r}{\alpha}=0$$
...
Skizze für eine mögliche Lösung der Lotka-Voltera-Gleichung:
\end{document}          
