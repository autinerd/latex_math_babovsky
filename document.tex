...
\begin{beispiel}
	...
	$x_0=0 \\ y_0=1 \\ h=0,1$ \\
	$x_1=x_0+h=0,1 \\ y_1=y_0+h\cdot \underbrace{f(x_0,y_0)}_{x_0\cdot y_0}=1+0,1\cdot 0\cdot 1 = 1$ \\
	$x_2=x_1+h=0,2 \\ y_2=y_1+h\cdot \underbrace{f(x_1,y_1)}_{x_1\cdot y_1}=1+0,1\cdot 0,1\cdot 1 = 1,01$ \\ \\ $h=0,1$ \\
	\begin{tabular}{| l | l | l |}
		$x$ & $y(x)$ & $y_i$ \\
		\hline
		$0,0$ & & \\
