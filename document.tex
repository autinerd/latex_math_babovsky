...
$$k_1=h\cdot f(x_i,y_i)$$ \\ Gesuchter Punkt: $f\left(x_0+\frac{h}{2},y\left(x_0+\frac{h}{2}\right)\right)$
$$P_3(x_0+h,y_0+k_3)$$
$$\frac{k_4}{h}=f(x_1,y_0+k_3)$$ 
Also wird $k=\frac{1}{6}(k_1+2k_2+2k_3+k_4)$\\$y_{i+1}=y_i+k$ $x_{i+1}=x_i+h$
\section{Weitere Beispiele mathematischer Anwendung in der Informatik}
\end{document}          
